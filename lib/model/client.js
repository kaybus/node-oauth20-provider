...
module.exports.checkSecret = function(client, secret) {
    /**
     * For example:
     * if (client.secret != superHashFunction(secret)) return true;
     * else false;
     */
...
module.exports.validateGuestExtensionID = function(req, client, cb) {
  throw new error.serverError('Client model method "validateGuestExtensionID" is not implemented');
};
