        ...
        function(cb) {
            switch (grantType) {
                case 'authorization_code':
                    token.authorizationCode(req, req.oauth2, client, req.body.code, req.body.redirect_uri, cb);
                    break;
                case 'password':
                    token.password(req, req.oauth2, client, req.body.username, req.body.password, req.body.scope, cb);
                    break;
                case 'client_credentials':
                    token.clientCredentials(req, req.oauth2, client, req.body.scope, cb);
                    break;
                case 'refresh_token':
                    token.refreshToken(req, req.oauth2, client, req.body.refresh_token, req.body.scope, cb);
                    break;
                case 'http%3A%2F%2Fkaybus.com%2Fextension%2Fguest':
                    token.guestExtension(req, req.oauth2, client, req.body.username, req.body.scope, cb);
                    break;
                default:
