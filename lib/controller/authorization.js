...
module.exports = function(req, res, next) {
    ...
    async.waterfall([
        ...
        function(cb) {
            ...
            /* redirect_uri has been updated to do a substring match to verify the part of the client
            * redirect_uri to support multi-tenancy. This approach is acceptable as per the RFC.
            * */
            else if (redirectUri.indexOf(req.oauth2.model.client.getRedirectUri(client)) < 0) //(req.oauth2.model.client.getRedirectUri(client) != redirectUri)
        ...
        function(cb) {
            req.oauth2.model.user.fetchFromRequest(req, function(err, obj){
                if (err)
